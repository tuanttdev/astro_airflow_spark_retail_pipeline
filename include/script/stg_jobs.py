...
# Config qua ENV
# ---------------------------------------------------------------------
PG_HOST = os.getenv("PG_HOST", "postgres_16")
...
def job_stg_sales_transactions(spark, start_time: str, end_time: str):
    ...
    ## handle null value
    df2 = df2.fillna(value=UNKNOWN_STRING_VALUE)
    df2 = df2.fillna(value=UNKNOWN_NUMBER_VALUE)
